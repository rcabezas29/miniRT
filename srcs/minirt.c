...
/*   Updated: 2020/10/09 10:40:27 by rcabezas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    setup_ray(t_minirt *r)
{
	...
	r->camera->right = cross_product(normalize_vec(r->camera->orientation), r->camera->up);
	r->camera->up = cross_product(r->camera->right, normalize_vec(r->camera->orientation));
    r->a = 0;
}
